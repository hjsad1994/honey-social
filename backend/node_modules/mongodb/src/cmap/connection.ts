...
import { type AutoEncrypter } from '../client-side-encryption/auto_encrypter.js';
import {
  CLOSE,
...
import type { ServerApi, SupportedNodeConnectionOptions } from '../mongo_client.js';
import { type MongoClientAuthProviders } from '../mongo_client_auth_providers.js';
import { MongoLoggableComponent, type MongoLogger, SeverityLevel } from '../mongo_logger.js';
import { type Abortable, type CancellationToken, TypedEventEmitter } from '../mongo_types.js';
import { ReadPreference, type ReadPreferenceLike } from '../read_preference.js';
import { ServerType } from '../sdam/common.js';
import { applySession, type ClientSession, updateSessionFromResponse } from '../sessions.js';
import { type TimeoutContext, TimeoutError } from '../timeout.js';
import {
  BufferPool,
...
import type { WriteConcern } from '../write_concern.js';
