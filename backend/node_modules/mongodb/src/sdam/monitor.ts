...
import { type Document, Long } from '../bson.js';
import { connect, makeConnection, makeSocket, performInitialHandshake } from '../cmap/connect.js';
import type { Connection, ConnectionOptions } from '../cmap/connection.js';
import { getFAASEnv } from '../cmap/handshake/client_metadata.js';
import { LEGACY_HELLO_COMMAND } from '../constants.js';
import { MongoError, MongoErrorLabel, MongoNetworkTimeoutError } from '../error.js';
import { MongoLoggableComponent } from '../mongo_logger.js';
import { CancellationToken, TypedEventEmitter } from '../mongo_types.js';
import {
